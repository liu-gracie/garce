...
//   try {
//     // Handle image requests for non-mother identities
//   if (imageRequest && (identity === 'friend' || identity === 'professor')) {
//     const blockMessages = {
//       friend: "I can't rn, maybe later.",
//       professor: "Sorry I don't know what you mean."
//     };
//     return res.json({
//       choices: [{ message: { content: blockMessages[identity] } }],
//       showImage: false
//     });
//   }
...
//     if (imageRequest && identity === 'mother') {
//       prompt += lastGraceMessage
//         ? `\nEarlier you said: "${lastGraceMessage}". Now describe vividly what you're doing right now in a way that could be turned into an image. Focus on setting, color, pose, and expression.`
//         : `\nPlease describe vividly what you're doing right now so it could be visualized in a picture. Include setting, color, pose, and facial expression.`;
//     }
...
//     const showImage = imageRequest && identity === 'mother';
//     res.json({ ...data, showImage });
...
//         input: { prompt: `TOK ${prompt}` } // 🔥 include the TOK keyword
//       })
//     });
